...
| A provider check returns invocation-required because `--allow-network` was omitted | Add the flag and retry; do not classify the provider or token as unavailable solely from the omission. |
