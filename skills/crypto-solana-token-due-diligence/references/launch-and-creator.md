...
`e0687ae9b7e064a0f54efc7297c65eecfbba3a8f`. File hashes are in
...
See the [pinned Pump interface notes](https://github.com/pump-fun/pump-public-docs/blob/e0687ae9b7e064a0f54efc7297c65eecfbba3a8f/README.md).
...
remain separate roles. The [pinned pool specification](https://github.com/pump-fun/pump-public-docs/blob/e0687ae9b7e064a0f54efc7297c65eecfbba3a8f/docs/PUMP_SWAP_README.md)
...
No local Pump quote is advertised. See the [pinned fee-selection document](https://github.com/pump-fun/pump-public-docs/blob/e0687ae9b7e064a0f54efc7297c65eecfbba3a8f/docs/FEE_PROGRAM_README.md).
